...
// send transactions
export const sendTransaction = (sourceAddress, sourceAddressPrivateKey, destinationAddress, amount, asset = "BITO", issuer = "GDMVBILCS2EI73QTMQGX7RKT5UED6P3KK5QVORBPVNBP53PBXNMLRDVG") => {
	return new Promise(async (resolve) => {
...
export const createTrust = (destinationAddress, destinationAddressPrivateKey, asset = "BITO", issuer = "GDMVBILCS2EI73QTMQGX7RKT5UED6P3KK5QVORBPVNBP53PBXNMLRDVG") => {
	return new Promise(async (resolve) => {
